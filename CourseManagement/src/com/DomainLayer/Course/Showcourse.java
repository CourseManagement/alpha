...
public class Showcourse extends Activity implements OnItemClickListener,
				...
				builder.setPositiveButton("确定",
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int whichButton) {
								// 事件处理
								if (begintime.getValue() <= closetime
										.getValue()) {
									String zhouxu = String.valueOf(begintime
											...
											+ String.valueOf(closetime
													.getValue());
									String bz = beizhu.getText().toString();
									...
									selectCourses
											.setSelectCoursesInfos(selectCoursesInfo);
									selectCourses.setUser_name(username
											.getText().toString());
	...
	public class SlideAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (slideView == null) {
				...
				slideView.setOnSlideListener(Showcourse.this);
			...
			holder.leftHolder.setOnClickListener(Showcourse.this);
			holder.rightHolder.setOnClickListener(Showcourse.this);
			return slideView;
		}
