 ...
 * @parameter *
 */
public class CheckSelectInfo extends Activity implements OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		Intent intent = new Intent(CheckSelectInfo.this,
				showCourseInfoAndSelectedTeacher.class);
